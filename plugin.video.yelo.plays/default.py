...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR white]||||||| ADDON Yelo Plays|||||||[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "Privado kkk"
...
url_origem = 'https://pastebin.com/raw/HZW6MGnR'
try:
...
def init_SKindex(msg):
   ...
   if status_mensagem1 == 'true':
    dialog = xbmcgui.Dialog()
    link = dialog.select("[B]BEM-VINDOS AO [COLOR white]YELO PLAYS[/COLOR][/B]", [
